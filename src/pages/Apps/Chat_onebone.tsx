...
// ✅ Contacts 임베드 렌더링
import Contacts from './Contacts'; // ⚠️ 경로 맞게 수정 (같은 폴더면 ./Contacts)
  ...
  return (
    <div>
      <div className={`flex gap-5 relative sm:h-[calc(100vh_-_150px)] h-full sm:min-h-0 ${isShowChatMenu ? 'min-h-[999px]' : ''}`}>
        {/* LEFT */}
        <div
          className={`panel p-0 flex-none max-w-xs w-full absolute xl:relative z-10 space-y-4 xl:h-full overflow-hidden
        ...
        >
          <div className="p-4">
            ...
            <div className="flex justify-between items-center text-xs mt-4">
              ...
              {/* ✅ Contacts: 빨간 박스(리스트)만 contacts로 보여줌 */}
        ...
        {/* RIGHT */}
        <div className={`panel p-0 flex-1 ${(!isShowUserChat && tab !== 'contacts') ? 'hidden xl:block' : 'block'}`}>
          {/* ✅ Contacts 화면을 Chat 안에 “그대로” 렌더링 */}
           {tab === 'contacts' && (
                  filteredItems && filteredItems.length > 0 ? (
          ...
          {/* ✅ Chat 안내 (데스크탑만) */}
          {tab !== 'contacts' && !isShowUserChat && (
            <div className="hidden xl:flex items-center justify-center h-full relative p-4">
          ...
          {/* ✅ Chat room */}
          {tab !== 'contacts' && isShowUserChat && selectedUser ? (
            <div className="relative h-full">
              ...
              <div className="flex justify-between items-center p-4">
                <div className="flex items-center space-x-2 rtl:space-x-reverse">
                  ...
                  >
                    {/* 햄버거 대신 back 아이콘 쓰고 싶으면 IconBack으로 교체 */}
                    <IconBack />
                  </button>
